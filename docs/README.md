...
| [Architecture](architecture.md) | Understand the Agent loop, trajectories, repository context, virtual patches, approval boundary, worktree execution, recovery, validation, persistence, and safety model. |
